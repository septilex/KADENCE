          ...
          >
            ...
            >
              <motion.a
                ...
                id="open-itunes-btn"
                whileHover={{ scale: 1.025, boxShadow: '0 6px 28px rgba(234,76,192,0.40)' }}
                whileTap={{ scale: 0.97 }}
                className="flex items-center justify-center gap-2.5 w-full py-3.5 rounded-2xl
                  bg-[#ea4cc0] text-white font-bold text-sm tracking-wide cursor-pointer
                  transition-colors duration-200 hover:bg-[#f85dd0]"
                style={{ boxShadow: '0 4px 20px rgba(234,76,192,0.28)' }}
              >
